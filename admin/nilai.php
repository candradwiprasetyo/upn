...
<fieldset>
<legend>Daftar Nilai perJurusan</legend>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="right"><form id="form_search" name="form_search" method="post" action="" onsubmit="return search_form('index.php?page=nilai')">
...
<tr ><td >No.</td><td id="i_sort"><a href="nilai.php?<?php echo $col1.$pageno_new.$search?>">Nama Jurusan</a></td>
<td id="i_sort"><a href="nilai.php?<?php echo $col2.$pageno_new.$search?>">Matakuliah</a></td>
<td id="i_sort"><a href="nilai.php?<?php echo $col3.$pageno_new.$search?>">Hari / Jam</a></td>
<td id="i_sort"><a href="nilai.php?<?php echo $col4.$pageno_new.$search?>">Ruang</a></td>
<td id="i_sort"><a href="nilai.php?<?php echo $col5.$pageno_new.$search?>">Kuota</a></td><td>Nilai</td></tr>
</thead>
<?php
...
if($n % 2){ $warna="#fff"; } else {$warna="#eee";}
	...
	<td>'.$r["ruang"].'</td>
	<td>'.$r["kuota"].'</td>
	<td align=center><a href="cetaknilai.php?idj='.$r['id_jadwal'].'"  title="Cetak Nilai - '.$r["nm_mk"].'" target=_blank>
...
if ($pageno == 1) {
   ...
   echo "<div class=\"page\" id =\"i_next\"> <a href='nilai.php?pageno=1$col$search'>FIRST</a></div> ";
   $prevpage = $pageno-1;
   echo "<div class=\"page\" id =\"i_next\"> <a href='nilai.php?pageno=$prevpage$col$search'>PREV</a></div> ";
} // if
...
if ($pageno == $lastpage) {
   ...
   $nextpage = $pageno+1;
   echo "<div class=\"page\" id =\"i_next\"> <a href='nilai.php?pageno=$nextpage$col$search'>NEXT</a></div> ";
   echo "<div class=\"page\" id =\"i_next\"=> <a href='nilai.php?pageno=$lastpage$col$search'>LAST</a></div> ";
} 
