...
<h2>Form Pendaftaran Online Pelatihan </h2>
...
<?php /*<tr><td>Sekolah Asal</td><td>: <input type="text" name="sekolah_asal" size="30"></td></tr> 
<tr><td colspan="2">
<fieldset>
...
<select name="id_jur"  >
   		 ...
   		 <?php if($idd){echo $rt['NM_JNS'];} else{echo "Silahkan Pilih";} ?>
      	</option>
   		 <?php 
