...
include "../koneksi.php";
$idj = $_GET['idj'];
$sql = @mysql_query("select * from tbl_pendaftaran where id_jadwal='1'");
$q = mysql_query("select * from tbl_pendaftaran a, tbl_jadwal b, tbl_jurusan c, tbl_mk d  
where b.id_jur=c.id_jur and b.id_mk=d.id_mk and a.id_jadwal=b.id_jadwal order by b.hari asc");
